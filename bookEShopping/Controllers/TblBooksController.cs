...
namespace bookEShopping.Controllers
{
    public class TblBooksController : Controller
    {
        ...
        public TblBooksController(OnineStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookName,BookImage,BookPrice,BookQuantity,BookSatuts,BookAuthor,BookCategory")] TblBook tblBook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,BookName,BookImage,BookPrice,BookQuantity,BookSatuts,BookAuthor,BookCategory")] TblBook tblBook)
        {
